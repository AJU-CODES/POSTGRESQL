...
INSERT INTO cars (brand,model,year) VALUES ('Ford','Mustang',1965)
...
UPDATE cars SET color = 'Black' WHERE brand = 'Ford'

ALTER TABLE cars ALTER COLUMN color TYPE VARCHAR(8)

ALTER TABLE cars DROP COLUMN color

DELETE FROM cars WHERE model = 'M1'
...
SELECT brand FROM cars WHERE year = 1965

SELECT brand FROM cars WHERE year > 1965

SELECT brand FROM cars WHERE year < 1985
...
SELECT model FROM cars WHERE model != 'Mustang'
...
SELECT * FROM cars WHERE model LIKE 'M%' AND brand LIKE '%W'

SELECT * FROM cars WHERE model LIKE '%g' OR 
model LIKE '%a'
...
SELECT * FROM customers WHERE customer_name ILIKE '%ma%'
...
SELECT testproduct_id,product_name,category_name,description FROM testproducts
...
UNION
SELECT testproduct_id,product_name FROM testproducts ORDER BY product_id
...
GROUP BY country HAVING COUNT(customer_id) > 5
...
GROUP BY order_id HAVING SUM(products.price) > 399
...
FROM customers WHERE EXISTS (SELECT order_id FROM orders 
